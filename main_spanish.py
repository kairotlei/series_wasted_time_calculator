...
print(f"""
¡Felicidades, al ver la serie '{series_name}' de principio a fin habrías perdido {wasted_time_hrs} horas de tu vida distribuídas en {seasons} temporadas con un total de {total_cha} capítulos!
...
En conclusión:
- Ver '{series_name}' te costará {wasted_time_hrs} horas de tu vida.
